            ...
            <div class="chat-input-wrapper">
                <div data-input-takers> 
                    ...
                    <div data-chat-ask class="ask-section">
                        <span data-chat-input-keyboard class="icon-sop icon-sop--keyboard left-icon"></span>
                        <span data-chat-input-mute class="icon-sop icon-sop--volume-mute"></span>
                        <span data-chat-input-restart class="icon-sop icon-sop--restart right-icon"></span>
