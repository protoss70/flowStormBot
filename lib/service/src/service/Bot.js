...
export default function Bot(url, deviceId, autoStart, clientCallback, fromKotlin = true, ttsFileType = 'mp3') {
	...
	bot.getFiles = async (query, url="https://manual-search-develop.alquist.ai/retrieve", callback=()=>{}) => {
		...
		// var results = null;
		// try{
		// 	results = await axios.post("https://upv-search-develop.alquist.ai/v2/models/upv-search/infer", {query: "Co je ochranná známka?"}, {headers: {"Content-Type": "application/json", "Access-Control-Allow-Origin": "*"}});
		// }
		// catch{
		// 	results = {}
		// }
